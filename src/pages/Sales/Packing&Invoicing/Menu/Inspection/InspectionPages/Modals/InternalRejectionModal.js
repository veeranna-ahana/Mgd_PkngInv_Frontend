...
export default function InternalRejectionModal(props) {
  ...
  const HandleRejectionReportClick = () => {
    console.log("entering into the HandleRejectionReportClick");
          ...
          <div className="row ">
            <div className="col-md-6 form-bg">
              <div style={{ marginBottom: "9px" }}>
                ...
                <input
                  className=""
                  value={`${props.headerData[0]?.Cust_name}(${selectedScheduleDetailsRows[0]?.Cust_Code})`}
                />
              </div>
            </div>
            <div className="col-md-3 form-bg">
              <label className="form-label">Rejection Ref</label>
              <input type="text" value={props.headerData[0]?.OrdSchNo} />
            </div>
            <div className="col-md-3 form-bg">
